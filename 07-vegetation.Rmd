...
library(here)
library(bookdown)
read_chunk('C:/Users/Maria Jose Rivera/OneDrive - James Cook University/Australia renamed/Sanamere/Thesis sections/PhD/preprocessing/pre_phy.R')

#need to include map with savannas..
# need to include pictures of plants, examples of phytoliths with pictures, in TABLE 2 include which part of the plant was sampled, italic scientific names
```
...
#print(fig3)
#include_graphics("other/Phy/Rplot.png")
#include_graphics("other/Phy/Rplot.png")
